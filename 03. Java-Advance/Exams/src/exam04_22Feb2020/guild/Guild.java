package exam04_22Feb2020.guild;
...
public class Guild {
    ...
    //Method promotePlayer(String name) - promote (set his rank to "Member") the first player with
    //the given name. If the player is already a "Member", do nothing.
    ...
    //Method demotePlayer(String name)- demote (set his rank to "Trial") the first player with the given
    //name. If the player is already a "Trial",  do nothing.
    ...
    //Method kickPlayersByClass(String clazz) - removes all the players by the given class and returns all
    //removed players from that class as an array
